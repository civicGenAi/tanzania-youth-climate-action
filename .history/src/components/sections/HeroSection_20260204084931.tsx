  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Mobile: Four floating images - strategically placed */}
        <motion.div
          className="absolute top-20 right-4 w-36 h-28 rounded-xl overflow-hidden shadow-xl opacity-50 lg:hidden"
        ...
        <motion.div
          className="absolute top-1/3 left-4 w-32 h-24 rounded-xl overflow-hidden shadow-xl opacity-40 lg:hidden"
        ...
        <motion.div
          className="absolute bottom-32 right-6 w-28 h-22 rounded-xl overflow-hidden shadow-xl opacity-35 lg:hidden"
        ...
        <motion.div
          className="absolute bottom-48 left-6 w-30 h-24 rounded-xl overflow-hidden shadow-xl opacity-30 lg:hidden"
          animate={{ y: [0, 10, 0], rotate: [0, -1, 0] }}
      ...
      <div className="container-main relative z-10 pt-28 pb-24 lg:pt-24 lg:pb-12 flex items-center min-h-screen">
        <div className="max-w-4xl w-full">
          {/* Main Heading */}
          <motion.h1
            className="text-[2.5rem] leading-[1.1] md:text-5xl lg:text-6xl font-bold text-foreground mb-12 lg:mb-8"
          ...
          >
            ...
            <Button variant="hero" size="xl" asChild className="lg:hidden rounded-full py-7 text-base">
              <Link to="/youth">
                Join the Network
              </Link>
            </Button>
